                ...
                size_t add_len )
{
    ...
    printf("\n\npule: mbedtls_gcm_starts(%p):add_len = %ld\n", ctx, add_len);
                ...
                unsigned char *output )
{
    ...
    printf("\n\npule: mbedtls_gcm_update(%p):length = %ld mode = %s\n", ctx, length, ctx->mode == MBEDTLS_GCM_DECRYPT ? "dec" : "enc");
                       ...
                       unsigned char *tag )
{
    ...
    printf("\n\npule: mbedtls_gcm_crypt_and_tag(%p):length = %ld add_len = %ld tag_len=%ld\n", ctx, length, add_len, tag_len);
                      ...
                      unsigned char *output )
{
    ...
    printf("\n\npule: mbedtls_gcm_auth_decrypt(%p):length = %ld add_len = %ld tag_len=%ld\n", ctx, length, add_len, tag_len);
