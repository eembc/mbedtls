                              ...
                              void *p_rng )
{
    ...
    printf("\n\npule: mbedtls_ecdh_make_params(%p):olen = %ld blen = %ld\n", ctx, *olen, blen);
#if defined(MBEDTLS_ECP_RESTARTABLE)
                              ...
                              const unsigned char *end )
{
    ...
    printf("\n\npule: mbedtls_ecdh_read_params(%p)\n", ctx);
                             ...
                             mbedtls_ecdh_side side )
{
    ...
    printf("\n\npule: mbedtls_ecdh_get_params(%p)\n", ctx);
                              ...
                              void *p_rng )
{
    ...
    printf("\n\npule: mbedtls_ecdh_make_public(%p):olen = %ld blen = %ld\n", ctx, *olen, blen);
#if defined(MBEDTLS_ECP_RESTARTABLE)
    restart_enabled = ctx->restart_enabled;
#endif
                              ...
                              const unsigned char *buf, size_t blen )
{
    ECDH_VALIDATE_RET( ctx != NULL );
    ECDH_VALIDATE_RET( buf != NULL );
    printf("\n\npule: mbedtls_ecdh_read_public(%p):blen = %ld\n", ctx, blen);
                              ...
                              void *p_rng )
{
    ...
    printf("\n\npule: mbedtls_ecdh_calc_secret(%p):olen = %ld blen = %ld\n", ctx, *olen, blen);
#if defined(MBEDTLS_ECP_RESTARTABLE)
    restart_enabled = ctx->restart_enabled;
#endif
